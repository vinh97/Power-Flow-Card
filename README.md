...
invert_battery2_power: false # Đặt true nếu công suất Pin 2 bị ngược dấu
...
always_show_battery2: false  # Đặt true nếu luôn muốn hiển thị khối Pin lưu trữ 2
...
entities:
  ...
  # --- Pin lưu trữ 2 (Battery 2 - Mới bổ sung) ---
